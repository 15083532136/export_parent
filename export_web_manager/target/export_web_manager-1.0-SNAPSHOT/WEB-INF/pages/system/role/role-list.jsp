            ...
            <div class="table-box">
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                        ...
                        <td>${o.roleId}</td>
                        <td><a href="/system/role/toUpdate.do?id=${o.roleId}">${o.name}</a></td>
                        <td>${o.remark}</td>
                        <th class="text-center"><button type="button" class="btn bg-olive btn-xs" onclick='location.href="/system/role/toUpdate.do?id=${o.roleId}"'>编辑</button></th>
                    </tr>
                    </c:forEach>
                    </tbody>
                </table>

...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
            ...
            <form id="editForm" action="/system/user/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" id="userName" placeholder="用户名称" name="userName" value="${user.userName}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" id="email" placeholder="邮箱" name="email" value="${user.email}">
                    </div>
        ...
        <div class="box-tools text-center">
            ...
            <button type="button" onclick='checkeSubmit()' class="btn bg-maroon">保存</button>
...
<script>
    ...
    //用户提交时检查用户的信息
    function checkeSubmit() {
        var userName = $("#userName").val();
        var email = $("#email").val();
        var password = $("#password").val();
        $.post({
            url:"/system/user/checkUser.do",
            data:{"userName":userName,"email":email,"password":password},
            success:function (result) {
                if (result.flag){
                    document.getElementById("editForm").submit();
                }else {
                   /* for (list of result.message){
                        //alert(mess);
                        //layer.msg(mess);
                        layer.tips(list.)
                    }*/
                   //map遍历
                    var map = result.message;
                    for (var key in map) {
                        layer.tips(map[key], "#" + key, {tips: 3})
                        //alert(map[key]);
                    }

                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <c:forEach items="${page.list}" var="o"  varStatus="st">
                        <tr>
                            ...
                            <th class="text-center"><button type="button" class="btn bg-olive btn-xs" onclick='location.href="/system/module/toUpdate.do?id=${o.moduleId}"'>编辑</button></th>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
